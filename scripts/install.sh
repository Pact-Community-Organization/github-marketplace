...
echo "Next steps:"
echo ""
echo "  1. Copy CLAUDE.md.template to ~/.claude/CLAUDE.md and fill in the placeholders:"
echo "       cp '$SRC/CLAUDE.md.template' '$CLAUDE_DIR/CLAUDE.md'"
echo ""
echo "  2. For each Pact project, copy the per-project template:"
echo "       cp '$SRC/project-templates/CLAUDE.md.project' /path/to/project/CLAUDE.md"
echo "       cp '$SRC/project-templates/STATUS.md.template' /path/to/project/STATUS.md"
echo ""
echo "  3. Configure hooks in ~/.claude/settings.json (or .claude/settings.json per project):"
echo "     See CLAUDE.md.template for the hooks snippet."
echo ""
echo "  4. Invoke the security auditor before shipping any module:"
echo "     In Claude Code, say: 'security review' or 'ready to ship'"
