---
name: mcp-tool-use
description: "Select and invoke pact/chainweb/coordination MCP tools. Decision tree, argument construction, and the prefer-MCP-over-bespoke rule."
---
...
If an MCP tool is missing a capability you need, escalate to Admin with a proposed tool signature. Do NOT paper over gaps with raw shell commands.
